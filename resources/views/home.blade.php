...
<head>
    ...
    <link rel="shortcut icon" href="{{ asset('assets/img/moriah-logo.png') }}" type="image/x-icon">
    <link rel="icon" href="{{ asset('assets/img/moriah-logo.png') }}" type="image/x-icon">
    ...
    <div class="vs-menu-wrapper">
        <div class="vs-menu-area">
            ...
            <div class="mobile-logo">
                <a href="{{ url('/') }}"><img src="{{ asset('assets/img/moriah-logo.png') }}" alt="Knirpse"></a>
            </div>
        ...
        <!--vs-main-menu-wrapper start-->
                ...
                <div class="header-menu-area">
                    ...
                    <div class="row gx-20 align-items-center justify-content-between">
                        ...
                        <div class="header-logo">
                            <a href="{{ url('/') }}">
                            <img src="{{ asset('assets/img/moriah-logo.png') }}" alt="Knirpse">
                            </a>
                        </div>
                        </div>
                        <div class="col-auto">
            ...
            <div class="container">
                ...
                <div class="col-lg-6 wow fadeInLeft" data-wow-delay="0.1s">
                    ...
                    <ul>
                        @foreach($homeIntroList->sections    as $item)
                        {!!$item->content!!}
                        @endforeach
                    </ul>
                    </div>
